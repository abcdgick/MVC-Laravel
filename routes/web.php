...
Route::get('/createbuku', 'App\Http\Controllers\ModelController@createbuku');
...
Route::get('/createanggota', 'App\Http\Controllers\ModelController@createanggota');
...
Route::get('/createpustakawan', 'App\Http\Controllers\ModelController@createpustakawan');
